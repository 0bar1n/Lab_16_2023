...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            string path = @"c:\\Users\Администратор\source\repos\404.html";

            if (url == "/connection/")
                path = @"c:\\Users\Администратор\source\repos\index.html";

            if (url == "/connection/main")
                path = @"c:\\Users\Администратор\source\repos\main.html";

            if (url == "/connection/about")
                path = @"c:\\Users\Администратор\source\repos\about.html";
